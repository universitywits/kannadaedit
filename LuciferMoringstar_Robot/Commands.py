    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**ನೀವು ನಮ್ಮ ಚಾನಲ್‌ನಲ್ಲಿಲ್ಲ ಆದ್ದರಿಂದ ನೀವು ಚಲನಚಿತ್ರವನ್ನು ಪಡೆಯುವುದಿಲ್ಲ ...\n**ಕೆಳಗಿನ 'JOIN MY UPDATE CHANNEL' ಬಟನ್ ಅನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ ಮತ್ತು ಚಲನಚಿತ್ರವನ್ನು ಪಡೆಯಲು ನಮ್ಮ ಮುಖ್ಯ ಚಾನಲ್‌ಗೆ ಸೇರುವ ಮೂಲಕ ಮಾತ್ರ ನೀವು ಈ ದೋಣಿಯ ಮೂಲಕ ಚಲನಚಿತ್ರವನ್ನು ಪಡೆಯಬಹುದು.\n**ಅದು ಪ್ರಾರಂಭವಾಗುವುದನ್ನು ನೋಡಲು ಪ್ರಯತ್ನಿಸಿ 'Try Again' ಕ್ಲಿಕ್ ಮಾಡಿ ಮತ್ತು ನೀವು ಚಲನಚಿತ್ರವನ್ನು ಪಡೆಯುತ್ತೀರಿ ...**",
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                InlineKeyboardButton("➕ 𝐀𝐃𝐃 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏 ➕", url='https://t.me/SIMBHA_NGY_BOT?startgroup=true')
                ],[
